...
def create_app(debug=False):
	...
	db.createUser(email='owner@email.com' ,password='password', role='owner', first_name="Test", last_name='Owner')
	db.createUser(email='owner2@email.com' ,password='password', role='owner', first_name="Test2", last_name='Owner2')
	db.createUser(email='owner3@email.com' ,password='password', role='owner', first_name="Test3", last_name='Owner3')
